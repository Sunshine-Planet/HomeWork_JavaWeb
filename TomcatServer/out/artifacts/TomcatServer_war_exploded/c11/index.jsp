...
<body class="main">
<!-- 1.网上书城顶部 start -->
<img src="ad/index_ad.jpg" alt="ad1" width="900px" height="335px"/>
<%@include file="head.jsp" %>
<!-- 网上书城顶部  end -->
<h2 style="color: darkorange">包含 include.jsp
...
<div id="box_autoplay">
    <div class="list">
        <ul>
            <li><img src="ad/index_ad1.jpg" alt="ad1" width="900px" height="335px"/></li>
            <li><img src="ad/index_ad2.jpg" alt="ad2" width="900px" height="335px"/></li>
            <li><img src="ad/index_ad3.jpg" alt="ad3" width="900px" height="335px"/></li>
            <li><img src="ad/index_ad4.jpg" alt="ad4" width="900px" height="335px"/></li>
            <li><img src="ad/index_ad5.jpg" alt="ad5" width="900px" height="335px"/></li>
        </ul>
    </div>
</div>
