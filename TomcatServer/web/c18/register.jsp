    ...
    <body>
      <div>
        <form action="el_get.jsp">
          ...
          密&nbsp;&nbsp;&nbsp;码: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="password" id=""><br><br>
          确认密码: &nbsp;<input type="text" name="repassword"><br><br><br>
          ...
          <input type="checkbox" name="hobby[]" id="">唱歌<br><br>
          备注: <textarea name="remark" id="" cols="60" rows="7"></textarea><br><br>
